...
RPC_CHAINSTACK_ARBITRUM_URL = os.getenv("RPC_CHAINSTACK_ARBITRUM_URL")
RPC_LIAMA_NODES_ARBITRUM_URL = os.getenv("RPC_LIAMA_NODES_ARBITRUM_URL")
RPC_ARBITRUM_URL = os.getenv("RPC_ARBITRUM_URL")
...
class Web3Manager:
    def __init__(self):
        self.rpcs = [
            ...
            RPC_CHAINSTACK_ARBITRUM_URL,
            RPC_LIAMA_NODES_ARBITRUM_URL,
            RPC_ARBITRUM_URL
        ]
