...
class WalletManagerFork(WalletBase, ABC):
    def __init__(self, web3_manager, properties: PropertiesBase):
        ...
        self.usdc_address = properties.USDC_ADDRESS_ARBITRUM
    ...
    def _bootstrap_fork_env(self):
        ...
        # 6. COMPRAR USDC PARA TESTES (Usando a conta do core)
        ...
        # Trocamos 10 ETH por USDC e enviamos para a conta do core
